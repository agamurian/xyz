...
declare type CommonProps<CustomModifierProps = Modifier.DefaultProps> = {
    value: any;
...
declare module Modifier {
    ...
    type DefaultProps = NumberProps & AgoProps & DateProps;
...
declare type Config<P = Parser.PayloadDefault, M = Modifier.DefaultProps> = Config$1.T<Parser.Params<P, M>>;
